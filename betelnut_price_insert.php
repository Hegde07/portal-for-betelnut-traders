...
$sql = "insert into betelnut_price(BETEL_NUT_NAME,BETEL_NUT_CATEGORY,QUALITY_LEVEL,QUANTITY,RATE,IMAGE,current_stock) values ('$BETEL_NUT_NAME','$BETEL_NUT_CATEGORY','$QUALITY_LEVEL','$QUANTITY','$RATE','$IMAGE','$QUANTITY')";
$rs=mysql_query($sql);
if($rs)
{
?>
