        ...
        <header class="market-header header">
            <div class="container-fluid">
                <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                    ...
                    <a href="#" class="navbar-brand" style="font-size:40px; color:#6600FF;"><strong>Betel Nut Traders</strong></a>
<div class="collapse navbar-collapse" id="navbarCollapse">
                        <?php include('dealer_menu.php');?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-12 align-self-center">
                        <h1 style="font-size:70px; height:700px; width:1200px; color:#FFFFFF; text-align:center; margin-left:-50px;">Welcome to Betel Nut Industry<p style="color:#FFFFFF; font-size:70px;">Dealer</p></h1>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="page-wrapper">
                            <div class="blog-custom-build">
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="marketing-single.html" title="">
                                            <img src="upload/market_blog_001.jpg" alt="" class="img-fluid">
                                    ...
                                    <div class="blog-meta big-meta text-center">
                                        <div class="post-sharing">
                                            <ul class="list-inline">
                                                <li><a href="betelnut_priceview.php" class="fb-button btn btn-primary"><!--i class="fa fa-facebook"--></i> <span class="down-mobile">View Product</span></a></li>
                                                <li><a href="send_orders.php" class="tw-button btn btn-primary"><!--i class="fa fa-twitter"--></i> <span class="down-mobile">Purchase Product</span></a></li>
                                                <!--li><a href="#" class="gp-button btn btn-primary"><i class="fa fa-google-plus"></i></a></li-->
                                            </ul>
                                        </div><!-- end post-sharing -->
                                        <h4><a href="marketing-single.html" title="">Betel Nut is Benificial for Anti cavity Effect </a></h4>
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <!--a href="marketing-single.html" title=""-->
                                            <img src="upload/market_blog_002.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                            <!-- end hover -->
                                    ...
                                    <div class="blog-meta big-meta text-center">
                                        ...
                                        <h4><a href="" title="">Betel Nut prevents Gum Infection</a></h4>
                                        <!--p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enimcerat elicerat eli nibh, maximus ac felis nec, maximus tempor odio.</p-->
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <!--a href="marketing-single.html" title=""-->
                                            <img src="upload/market_blog_003.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                            <!-- end hover -->
                                    ...
                                    <div class="blog-meta big-meta text-center">
                                        ...
                                        <h4><a href="" title="">Betel Nut Reduces Schizophrenia</a></h4>
                                        <!--p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enimcerat elicerat eli nibh, maximus ac felis nec, maximus tempor odio.</p-->
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <!--a href="marketing-single.html" title=""-->
                                            <img src="upload/market_blog_004.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                            <!-- end hover -->
                                    ...
                                    <div class="blog-meta big-meta text-center">
                                        ...
                                        <h4><a href="" title="">Chewing the nut stimulates the flow of saliva to aid digestion</a></h4>
                                        <!--p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enimcerat elicerat eli nibh, maximus ac felis nec, maximus tempor odio.</p-->
                                        <!--small><a href="marketing-category.html" title="">Technology</a></small>
                                        <small><a href="marketing-single.html" title="">20 July, 2017</a></small>
                                        <small><a href="#" title="">by Martin</a></small-->
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <!--a href="marketing-single.html" title=""-->
                                            <img src="upload/market_blog_005.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                            <!-- end hover -->
                                    ...
                                    <div class="blog-meta big-meta text-center">
                                        ...
                                        <h4><a href="" title="">Arecoline is responsible for Alertness,Increased stamina</a></h4>
                                        <!--p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enimcerat elicerat eli nibh, maximus ac felis nec, maximus tempor odio.</p-->
                                        <!--small><a href="marketing-category.html" title="">Technology</a></small>
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <!--a href="marketing-single.html" title=""-->
                                            <img src="upload/market_blog_006.jpg" alt="" class="img-fluid">
                                            <div class="hovereffect">
                                                <span></span>
                                            </div>
                                            <!-- end hover -->
                                    ...
                                    <div class="blog-meta big-meta text-center">
                                        ...
                                        <h4><a href="" title="">Betel Nut also has been used to stimulate the appetite</a></h4>
                                        <!--p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enimcerat elicerat eli nibh, maximus ac felis nec, maximus tempor odio.</p-->
                                        <!--small><a href="marketing-category.html" title="">Technology</a></small>
                                        <small><a href="marketing-single.html" title="">19 July, 2017</a></small>
                                        <small><a href="#" title="">by Martin</a></small-->
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="sidebar">
                            <div class="widget">
                                <h2 class="widget-title">Newly Introduced Betel Nut</h2>
                                    ...
                                    <div class="list-group">
                                        <!--a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start"-->
                                            <div class="w-100 justify-content-between">
                                                ...
                                                <h5 class="mb-1">Areca catechu</h5>
                            ...
                            <div id="" class="widget">
                                <h2 class="widget-title">Fresh product</h2>
                            ...
                            <div class="widget">
                                <h2 class="widget-title">Categories of Betel Nut</h2>
                            ...
                            <div class="widget">
                                ...
                                <div class="link-widget">
                                    <ul>
                                        <li><a href="#">Rashi<span>35058</span></a></li>
                                        <li><a href="#">Bette<span>29109</span></a></li>
                                        <li><a href="#">Kole<span>21169</span></a></li>
                                        <li><a href="#">Chali<span>31099</span></a></li>
                                        <li><a href="#">Pepper<span>17099</span></a></li>
                                        <li><a href="#">B.G. <span>25379</span></a></li>
                                        <li><a href="#">Ch. K<span>32339</span></a></li>
                                    </ul>
                                </div><!-- end link-widget -->
                            </div><!-- end widget -->
                        </div><!-- end sidebar -->
    ...
    <head><script>window.history.forward();</script></head>
