...
<form id="form1" name="form1" method="post" action="warehouse-insert.php">
  <?php
  require_once('dbcon.php');
  $ss="select max(wid) from warehouse";
  $rs=mysql_query($ss);
  ...
  <table width="406" height="581" align="center" style="margin-left:70px;">
    <tr>
      ...
      <td width="181"><label>
        <input type="text" name="t1" id="t1" required  value="<?php echo $count;?>" readonly />
      </label></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="56"><span class="style13">BetelNut Name</span></td>
      <td><input type="text" name="t5" id="t5" required pattern="[A-Za-z\s]+" title="Enter a valid name" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="number" name="t8" id="t8" required /></td>
    </tr>
    <tr>
