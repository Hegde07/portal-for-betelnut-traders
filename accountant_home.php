...
<div class="collapse navbar-collapse" id="navbarCollapse"> 
                        <?php include('accoutant_menu.php');?>                       
                    </div>
                    <p style="font-size:18px; width:300px; margin-top:30px;"></p>
                </nav>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-12 align-self-center">
                        <h1 style="height:700px; width:1200px; color:#FFFFFF; font-size:70px; margin-left:-50px; text-align:center;">Welcome to Betel Nut Industry<p style="font-size:70px; color:#FFFFFF;">Accountant</p> </h1>
                        ...
                        <div class="page-wrapper">
                            <div class="blog-custom-build">
                                ...
                                <div class="blog-box wow fadeIn">
                                    ...
                                    <div class="blog-meta big-meta text-center" style="margin-top:100px;">
                                       <!-- end post-sharing -->
                                        <h4><a href="" title="">Betel Nut is Benificial for Anti cavity Effect </a></h4>
