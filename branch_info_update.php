...
.style8 {color: #000000; font-size: 30px; font-weight: bold;}
</style>
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="sidebar" style="width:1500px; margin-left: -193px; margin-top:-63px; margin-bottom:-110">
                            <div class="widget-no-style">
                                <div class="newsletter-widget text-center align-self-center">
                                <form action="branch_info_db.php" method="post" enctype="multipart/form-data" name="form1">
<?php
$id=$_GET['id'];
...
?>
  <table width="635" align="center" style="margin-left:70px;">
  <input type="hidden" name="id" value="<?php echo $id;?>" />

    <tr>
      <td width="418" height="60"><span class="style8">BRANCH NAME </span></td>
      <td width="205"><label>
